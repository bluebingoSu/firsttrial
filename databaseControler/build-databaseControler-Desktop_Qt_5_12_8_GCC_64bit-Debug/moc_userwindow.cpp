...
#include "../databaseControler/userwindow.h"
...
QT_MOC_LITERAL(1, 11, 10), // "returnMain"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9), // "showTable"
QT_MOC_LITERAL(4, 33, 12), // "showTableOne"
QT_MOC_LITERAL(5, 46, 2) // "id"

    },
    "UserWindow\0returnMain\0\0showTable\0"
    "showTableOne\0id"
};
...
void UserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->showTableOne((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWindow::returnMain)) {
                *result = 0;
                return;
            }
        }
