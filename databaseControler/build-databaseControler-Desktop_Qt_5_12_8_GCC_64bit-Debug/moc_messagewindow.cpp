...
#include "../databaseControler/messagewindow.h"
...
QT_MOC_LITERAL(1, 14, 10), // "returnMain"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 11), // "showMessage"
QT_MOC_LITERAL(4, 38, 14), // "showMessageOne"
QT_MOC_LITERAL(5, 53, 10) // "idReceiver"

    },
    "MessageWindow\0returnMain\0\0showMessage\0"
    "showMessageOne\0idReceiver"
};
...
void MessageWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->showMessageOne((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MessageWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageWindow::returnMain)) {
                *result = 0;
                return;
            }
        }
